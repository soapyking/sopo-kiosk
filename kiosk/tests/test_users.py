...
class TestUser:
	...
	def test_insert_user(self, session_fixture):
		...
		test_user.uname = 'tuser'
		test_user.fullname = 'test_user'
	...
	def test_insert_guest(self, session_fixture, test_insert_user):
		...
		test_guest.uname = 'tguest'
		test_guest.fullname = 'test_guest'
	...
	def test_recognition(self, client_fixture, session_fixture, test_insert_guest):
		...
		response = client_fixture.post('/signin', data={'uname': 'tuser'})
		assert 0
